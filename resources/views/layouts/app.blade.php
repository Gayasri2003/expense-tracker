        ...
        <div class="flex min-h-screen">
            ...
            <aside class="w-64 bg-navy-950 text-white hidden lg:flex flex-col sticky top-0 h-screen shadow-2xl z-50 shrink-0">
                ...
                <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('loans') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-2xl transition-all {{ request()->routeIs('loans') ? 'bg-gold-700 text-white shadow-lg' : 'text-navy-300 hover:bg-navy-900 hover:text-white' }}">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        <span class="font-semibold text-sm">Loans & Leases</span>
                    </a>
            ...
            <aside x-show="mobileSidebarOpen"
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('loans') }}" class="flex items-center space-x-3 px-4 py-3 rounded-2xl transition-all {{ request()->routeIs('loans') ? 'bg-gold-700 text-white shadow-lg' : 'text-navy-300 hover:bg-navy-900 hover:text-white' }}">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        <span class="font-semibold text-base">Loans & Leases</span>
                    </a>
